...
namespace csFinalProject.pchrDataSetTableAdapters {
...
SELECT PATIENT_ID, ALLERGY_ID, ALLERGEN, ONSET_DATE, NOTE FROM ALLERGY_TBL WHERE (ALLERGY_ID = @ALLERGY_ID) AND (PATIENT_ID = @PATIENT_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::csFinalProject.Properties.Settings.Default.pchrdbConnectionString;
        }
